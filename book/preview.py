...
Usage:
    ...
    python preview.py --year 1972        # Preview specific year
    python preview.py --era 70s          # Preview specific era
...
def main():
    ...
    with socketserver.TCPServer(("", args.port), handler) as httpd:
        ...
        print(f"\n{'='*60}")
        print(f"Preview server running!")
        print(f"{'='*60}")
        print(f"\nOpen in browser: {url}")
